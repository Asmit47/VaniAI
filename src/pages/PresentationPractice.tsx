...
const PresentationPractice = () => {
  ...
  const processPresentation = async () => {
    ...
    try {
      ...
      // Analyze via Gemini
      const prompt = `You are a presentation coach. Analyze the following transcript of a presentation titled "${fileName}" and provide concise, actionable feedback (structure, clarity, delivery, and 3 improvement tips). Return plain text.\n\n${transcriptText}`;
